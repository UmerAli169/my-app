...
const AccountSidebar = () => {
  ...
  const links = [
    { label: "Contact Information", href: "/Account/ContactInformationForm", className: "text-[#383838] font-semibold" },
    { label: "Change Password", href: "/Account/ChangePasswordForm", className: "text-[#383838] font-semibold" },
    { label: "Addresses", href: "/Account/AddressForm", className: "text-[#383838] font-semibold" },
  ];
