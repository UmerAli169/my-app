...
<div></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#FFFFFF] text-[16px] font-[poppins] leading-[22px]">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#FFFFFF] text-[14px] font-[poppins] leading-[20px]">
              ...
              <div className="flex">
                ...
                <button className="px-4 py-2 text-white rounded-r  text-[14px] font-[poppins]">
                  Subscribe →
                </button>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-4">
                {data.bottom.policies.map((policy: any) => (
                  <Link key={policy.label} href={policy.href} className="text-[#FFFFFF] text-[14px] font-[poppins] hover:text-gray-800">
                    {policy.label}
                  </Link>
                ))}
              </div>
